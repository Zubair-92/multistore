            ...
            <form action="{{ route('admin.subadmins.store') }}" method="POST">
                ...
                <div class="row g-3">
                            ...
                            @foreach($availablePermissions as $permission => $label)
                                <div class="col-md-6">
                                    <div class="form-check border rounded p-3 h-100">
                                        <input class="form-check-input" type="checkbox" name="admin_permissions[]" value="{{ $permission }}" id="perm_{{ $permission }}" @checked(in_array($permission, old('admin_permissions', [])))>
                    ...
                    <div class="col-12 d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">Save Subadmin</button>
                    </div>
                </div>
            </form>
        </div>
